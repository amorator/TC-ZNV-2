...
graceful_timeout = 10  # Время на graceful shutdown (уменьшено для быстрого выхода)
...
preload_app = False  # Отключено для корректной работы Socket.IO с Redis в мультиворкере
