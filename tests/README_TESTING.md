# Автоматизированное тестирование ZNF

## Обзор

Реализован комплексный фреймворк автоматизированного тестирования для веб-приложения ZNF, включающий UI/UX тесты, backend валидации, realtime функциональность и RBAC проверки.
