	...
	def permissions(self):
		...
		try:
			from modules.permissions import (
				...
				REQUESTS_VIEW_PAGE, ORDERS_VIEW_PAGE, ORDERS_CREATE, ORDERS_EDIT_ANY, ORDERS_DELETE_ANY, ORDERS_VIEW_ALL, ORDERS_APPROVE, ORDERS_NOTES, ORDERS_FILES_VIEW, ORDERS_FILES_EDIT,
