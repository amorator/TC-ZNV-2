	...
	def permissions(self):
		...
		try:
			from modules.permissions import (
				...
				REQUESTS_VIEW_PAGE, ORDERS_VIEW_PAGE, ORDERS_CREATE, ORDERS_EDIT_ANY, ORDERS_DELETE_ANY, ORDERS_VIEW_ALL, ORDERS_APPROVE, ORDERS_STATUS_CHANGE, ORDERS_NOTES, ORDERS_FILES_VIEW, ORDERS_FILES_EDIT, ORDERS_EDIT_APPROVED,
				USERS_VIEW_PAGE, USERS_MANAGE,
		...
		mapping = {
			...
			2: {
				...
				'e': ORDERS_APPROVE,
				'f': ORDERS_VIEW_ALL,
				'g': ORDERS_STATUS_CHANGE,
				'h': ORDERS_EDIT_APPROVED,
				'l': ORDERS_NOTES,
				'm': ORDERS_FILES_EDIT,
				'n': ORDERS_FILES_VIEW,
				'z': ADMIN_ANY,
